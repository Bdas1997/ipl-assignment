...
if ($delid != ""){
    ...
    $upsql = "delete from player where id={$delid}";            
    ...
    header("Location: mng_player.php");
...
?>
                                ...
                                <td><?php echo $i++;?></td>
									...
									<td><a href="add_player.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit" style="color:#000;"></i></a> |
